...
static const float NbSamples = 12.0f;
...
{ 
	...
	Vector.x =  pixelVector.r * g_BlurFactor;
	Vector.y = -pixelVector.g * g_BlurFactor;
    ...
    Output.RGBColor = float4(Blurred / NbSamples, 1.0f);
    
    //// Delete Me !!!!
    //Output.RGBColor = tex2D(VectorsTexture, UV);
