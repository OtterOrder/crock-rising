...
#define		OBJECT2D_DEFAULT_SIZE	(Vector3f( 0.f, 0.f, 0.f ))	// Taille par défaut
#define		OBJECT2D_DEFAULT_POS	(Vector3f( 0.f, 0.f, 0.f ))	// Position par défaut
#define		OBJECT2D_DEFAULT_SCALE	(Vector3f( 1.f, 1.f, 1.f ))	// Echelle par défaut
#define		OBJECT2D_DEFAULT_COLOR	(Color4f( 1.f, 1.f, 1.f, 1.f ))// Couleur par défaut
